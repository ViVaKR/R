...
-   Move cursor to beginning of line Home Cmd+Left \# Move cursor to end of line End Cmd+Right \# Navigate command history Up/Down Up/Down \# Popup command history Ctrl+Up Cmd+Up \# Interrupt currently executing command Esc Esc \# Change working directory Ctrl+Shift+H Ctrl+Shift+H
